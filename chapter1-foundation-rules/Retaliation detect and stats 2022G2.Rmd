...
#write.csv(masterframe_retaliation.df_time_2022G2,  here("ch1 data","retal2022G2timemaster.csv"), row.names = FALSE)
...
```{r}
#masterframe_retaliation.df_time_2022G2 <- read_csv(here("ch1 data","retal2022G2timemaster.csv"))
...
#write.csv(masterframe_retaliation.df2022G2,  here("ch1 data","retal2022G2countmaster_global_75perc.csv"), row.names = FALSE)
...
#masterframe_retaliation.df2022G2 <- read_csv(here("ch1 data","retal2022G2countmaster_global_75perc.csv"))
...
retal_nofollow <- setdiff(unique(c(t2022G2_aggression_only_ready$actor, t2022G2_aggression_only_ready$subject)), unique(retal_doner_all_yes$actor_2)
 )
